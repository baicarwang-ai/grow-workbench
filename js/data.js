...
/* ---------------- 常见食物热量库（每 100 克千卡，参考中国食物成分表近似值） ----------------
 * 格式：[名称, kcal/100g, [别名...]]
 * 用于「热量估算器」：输入"米饭200g 鸡胸肉150g"自动计算总热量。 */
const FOOD_CALORIES = [
  /* 主食 */
  ["米饭", 116, ["白饭", "大米饭"]],
  ["馒头", 223],
...
/* ---------------- 单份克重参考表（用于"个/片/碗/根"等个数单位换算） ----------------
 * 名称 → 每份约多少克。未列出的食物按 1 份 ≈ 100g 粗略估算。 */
const FOOD_UNIT_GRAMS = {
  "汉堡": 200, "包子": 70, "饺子": 20, "馄饨": 12, "汤圆": 20,
  "粽子": 150, "烧麦": 30, "馒头": 100, "油条": 60, "煎饼": 150, "肠粉": 250,
  "香蕉": 120, "苹果": 200, "橙子": 150, "梨": 200, "桃子": 200, "猕猴桃": 80,
  "芒果": 150, "火龙果": 300, "樱桃": 8, "草莓": 15, "牛油果": 140,
  "鸡腿": 100, "鸡翅": 50, "鸭蛋": 60, "鹌鹑蛋": 10, "鸡蛋": 50,
  "牛奶": 250, "可乐": 500, "酸奶": 200, "面包": 40, "全麦面包": 35,
  "米饭": 150, "面条": 250, "啤酒": 330, "冰淇淋": 80,
};
